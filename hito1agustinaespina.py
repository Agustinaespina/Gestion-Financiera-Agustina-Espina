# -*- coding: utf-8 -*-
"""Hito1AgustinaEspina.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/16cgQqkHEOtBTbAzOfkrV9S7CZOnFekor
...
W = Matrix([[-4000000, -38.11], [0.051*4000000, 0.0826*38.11],[0.051*4000000, 0.0157*38.11]])
W
...
# Parámetros Acción
u, d, S0 = 1.5, 0.5, 100
W = Matrix([[-4000000, -38.11, -q3], [0.051*4000000, 0.0826*38.11, max(0,0.0826*38.11-50)],[0.051*4000000, 0.0157*38.11, max(0,0.0157*38.11-50)]])
W
